(function () {
    ...
    angular
            ...
            .controller('HomeController', function (reservasService, sessionService, canchaService,clienteService, $scope) {
                    ...
                    if (localStorage.getItem('canchas') === null) {
                        ...
                        promisePost.then(function (d) {
                            ...
                            if (err.status == 401) {
                                ...
                                toastr["error"]("Ha ocurrido un problema al consultar las canchas!");
                            }
                        });
